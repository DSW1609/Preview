$(function () {
  ...
  $(".JDD").click(function () {
    ...
    if (JDD_Flag && Jh_I >= 1) {
      ...
      // 获得随机数
      var SJX = Math.floor(Math.random() * JDD_XX.length);
      // 添加抽奖信息
      // 信息标题
      $(".Xx_Tt").text(JDD_XX[SJX].Tit);
      // 信息信息
      $(".Xx_Xx").text(JDD_XX[SJX].Xx);
      setTimeout(function () {
        // 更改金蛋蛋图片
        $(".JDD").addClass("JDDS");
        // 点击次数-1
